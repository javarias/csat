...
Para la presentaci\'on de la feria, Hevelius ser\'a probado en un telescopio amateur el cual es propiedad de NO SE QUIEN ES EL DUEÑO.TOBAR?? =P, por lo que la disponibilidad de este se puede ver afectada para dicha presentaci\'on.
...
3.- Estimaci\'on del proyecto err\'onea.

4.- Falta de conocimiento en cuanto al \'area de desarrollo.

5.- Pocas pruebas realizadas al proyecto.

6.- No cumplimiento con los est\.andares del proyecto ALMA-CONICYT

7.- Mala elecci\'on en cuanto a lenguajes de programaci\'on.

8.- Telescopio amateur no disponible.

9.- Ausencia de alg\'un integrante del proyecto

10.- No cumplimiento con los est\'andares del proyecto ALMA-CONICYT


\subsection{Preparaci\'on para control de riesgos}

%%%FALTAN LAS CARTAS PERO SON DEMACIADA GESTION PARA UNA SOLA PERSONA X_X %%%
