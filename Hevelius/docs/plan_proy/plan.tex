...
Persona resposable y met\'odica. Es una persona que se esfuerza por lograr que
las cosas funcionen bien, para lo cual utiliza tanto los conocimientos que ha
obtenido como soluciones que el mismo pueda ingeniar.
...
detallista, perfeccionista, perseverante, comprometido, responsable, 
...
la interfaz de nuestro software.
			\item{C, C++, Phyton:} Estos lenguajes de programaci\'on ser\'án usados en la creaci\'on 
