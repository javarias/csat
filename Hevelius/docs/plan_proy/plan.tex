...
Para la presentaci\'on de la feria, Hevelius ser\'a probado en un telescopio amateur el cual es propiedad de NO SE QUIEN ES EL DUEÑ.TOBAR?? =P, por lo que la disponibilidad de este se puede ver afectada para dicha presentaci\'on.
