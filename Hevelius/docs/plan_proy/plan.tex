...
Los telescopios son una herramienta fundamental para la astronomia, cada
perfeccionamiento del telescopio ha sido seguido de avances en la compresi\'on 
del universo.
...
El par\'ametro m\'aimportante de un telescopio es el di\'ametro de su objetivo. 
...
profundo (c\'umulos, nebulosas y algunas galaxias) que es con el que nosotros
trabajaremos. Los telescopios que superan  los 0,20 m de di\'ametro permiten 
ver detalles lunares finos, detalles planetarios importantes y una gran cantidad 
de c\'umulos, nebulosas y galaxias brillantes y que se encuentran implementados en
los observatorios, y es a los que trata de abarcar nuestro software.
...
Como ya se puede apreciar es bastante complejo los componentes de los telescopio, pero m\'as a\'un cuando se quiere 
obtener la ubicaci\'on de alguna estrella u objeto celeste, ya que no es s\'olo dar coordenadas, ya que tanto el objeto a
observar como nuestro punto base(la tierra) se mueven en distintas formas, ya que durante el transcurso de un d\'ia, 
la Tierra se habr\'a movido un poco a lo largo de su \'orbita alrededor del Sol, por lo que debe girar una peque\~na 
distancia angular extra antes de que el Sol alcance su punto m\'as alto. En cambio las estrellas est\'an tan alejadas 
que el movimiento de la Tierra a lo largo de su \'orbita genera una diferencia apenas apreciable con respecto a su 
direcci\'on aparente, por lo que vuelven a su punto m\'as alto en algo menos de 24 horas o d\'ia solar. Una idea de esta
...
Por lo que existen coordenadas especiales como son Sistema de coordenadas horizontales, Ecuatorianas, Ecl\'ipticas, 
entre otras, para poder controlan esta situaci\'on, las cuales usan como referencia la hora actual, 
ubicaci\'on entre otras.
 Adem\'as de estas condiciones existe una gran cantidad de cosas que afectan el poder
realizar este tipos de observaciones, como son la luz solar, que da\~na los telescopio, algunas condiciones
climaticas, la luminocidad de la luna entre otras cosas, lo que hace que los operadores de telescopios esten
sumamente atento a estos importante acontecimientos que pueden da\~nar gravemente el telescopio, actualmente existe
c\'upulas donde su funci\'on consiste en proteger el telescopio y la instrumentaci\'on cient\'ifica, al tiempo que sigue sus
 movimientos y le permite explorar la b\'oveda celeste.
\newpage
\begin{figure}[h!]
 \centering
...
Despu\'es de esta peque\~na descripci\'on podemos apreciar que para poder manejar un telescopio se necesitan d\'ias de preparaci\'on
antes de poder trabajar con el telescopio, ya que sus interfaces son complicadas y muy detalladas
y para cada telescopio existe una interfaz distinta, implementada de distinta manera, dependiendo del lugar
en donde se creo, puede estar en diversos idiomas, un ejemplo de una interfaz es la que se muestra acontinuaci\'on:
...
Podemos observar la confuci\'on que puede lograr y lo poco amigable que son estas interfaces actualmente, y en en la mayoria
tienen toda la informaci\'on necesaria para un astronomo de una forma desordenada y poco estandar.
 Como la mayoria del tiempo el astronomo esta en busca de nuevos descubrimientos que ayuden al entendimiento del universo
no se centran mucho en observar estrellas ya existentes, m\'as que para referencias para observar algo que podr\'ia estar 
cerca, y para ello deben consultar catalogos de estrellas, siendo un atraso la busqueda de ella en el tiempo de observaci\'on.
...
\hline
2 & Seguimiento de Estrellas & Jun 22 & Aug 15 &  \\
\hline
2.1 & Tracking & Jun 22 & Jul 23 & E, T \\
\hline
2.2 & Pointing Manual & Jul 24 & Aug 10 & C, E, M, T \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{10mm}|p{50mm}|p{20mm}|p{20mm}|p{30mm}|}
\hline
2.3 & Presenting & Jun 22 & Jul 23 & C, M \\
\hline
2.4 & Testeo y Uni\'on & Aug 13 & Aug 15 & C, E, M, T \\
\hline
2.5 & Segundo Entregable & Aug 15 & Aug 15 &  \\
\hline
3 & Restricciones & Aug 15 & Sep 14 &  \\
\hline
3.1 & Restricciones de Observaci\'on & Aug 15 & Sep 11 & C, M \\
\hline
3.2 & Modelo OpenGL & Aug 15 & Sep 11 & E, M \\
\hline
3.3 & Bot\'on de Emergencia & Aug 15 & Sep 11 & E, T \\
\hline
3.4 & Testeo y Uni\'on & Sep 12 & Sep 14 & C, E, M, T \\
\hline
3.5 & Tercer Entregable & Sep 14 & Sep 14 &  \\
\hline
4 & Accesorios & Sep 17 & Oct 11 &  \\
\hline
4.1 & Acceso Remoto & Sep 17 & Oct 1 & C, T \\
\hline
4.2 & Login & Sep 17 & Oct 1 & E, M \\
\hline
4.3 & Historial & Oct 2 & Oct 8 & C, T \\
\hline
4.4 & Testeo y Uni\'on & Oct 9 & Oct 11 & C, E, M, T \\
\hline
...
%\paragraph{Detalle de cada Tarea}
...
\textit{2.1} & \multicolumn{4}{|p{120mm}|}{\textit{Tracking}} \\ \hline
...
\textit{2.2} & \multicolumn{4}{|p{120mm}|}{\textit{Pointing Manual}} \\ \hline
...
%\begin{tabular}{|p{30mm}|p{30mm}|p{30mm}|p{30mm}|p{30mm}|}
%\hline
\textit{2.5} & \multicolumn{4}{|p{120mm}|}{\textit{Segundo Entregable}} \\ \hline
...
\textit{3.1} & \multicolumn{4}{|p{120mm}|}{\textit{Restricciones de Observaci\'on}} \\ \hline
...
\textit{3.2} & \multicolumn{4}{|p{120mm}|}{\textit{Modelo OpenGL}} \\ \hline
...
\textit{4.2} & \multicolumn{4}{|p{120mm}|}{\textit{Login}} \\ \hline
\multicolumn{5}{|p{150mm}|}{\textbf{\textit{Entregable:}} Sistema de acceso controlado al panel de control.} \\ \hline

\textit{4.3} & \multicolumn{4}{|p{120mm}|}{\textit{Historial}} \\ \hline
...
Considerando las tareas anteriormente listadas y detalladas se ha estimado el esfuerzo en horas persona de
...
\hline
Carlos Guajardo & 674 horas \\
\hline
Tom\'as Staig & YYY horas \\
\hline
Marina Pilar & WWW horas \\
\hline
Esteban Espinoza & ZZZ horas \\
\hline
\end{tabular}
\end{table}

El esfuerzo total del proyecto en horas persona es de 1736, dado que este valor es mejor al total de horas
disponibles para el proyecto se establece la factibilidad del mismo (esto sólo respecto de horas de trabajo
por persona).
