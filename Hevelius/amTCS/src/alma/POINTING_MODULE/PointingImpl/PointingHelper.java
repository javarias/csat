...
import alma.POINTING_MODULE.PointingPOATie;
 ...
 * <p>
 * Name="POINTING_1" Code="alma.POINTING_MODULE.PointingImpl.PointingHelper" Type="IDL:alma/POINTING_MODULE/Pointing:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class PointingHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public PointingHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return PointingOperations.class;
	}
