...
%\begin{figure}[h!]
% \centering
% \includegraphics[scale=0.5]{hevelius.eps}
...
La plataforma en la que se desarrolla actualmente Hevelius  consiste en el Sistema Operativo Linux, el software ACS 6.0, Java version "1.5.0\_04" y jogl-1\_0\_0-linux-i586.
...
\item 1Gb RAM
\item Telescopio NEXSTAR 4 SE que posee computador manual de 16 caracteres con pantalla LCD y 19 botones. Algunas de sus caracteríicas: apertura de 102 mm, largo focal de 1325 mm, radio focal de 12.99 mm, entre otras cosas.
\item Adjunto al telescopio un CCS para la obtenci\.on de im\.agenes.
\item GPS para la obtenci\.on de ubicaci\.on de ubicaci\.on del telescopio.
\end{itemize}
\end{itemize}
