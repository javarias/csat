#ifndef HPTWEBCAMGUIEVENTLOOP_H
#define HPTWEBCAMGUIEVENTLOOP_H

/*
 * "@(#) $Id: hptWebCamGUIEventLoop.h,v 1.1.1.1 2007/07/09 12:47:39 wg8 Exp $"
 *
 * $Log: hptWebCamGUIEventLoop.h,v $
