...
import alma.LOCALE_MODULE.LocalePOATie;
import alma.LOCALE_MODULE.LocaleImpl.LocaleImpl;
 ...
 * <p>
 * Name="LOCALE_1" Code="alma.LOCALE_MODULE.LocaleImpl.LocaleHelper" Type="IDL:alma/LOCALE_MODULE/Locale:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class LocaleHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public LocaleHelper(Logger containerLogger)
	{
