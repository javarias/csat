...
import alma.CSATCONTROL_MODULE.CSATControlPOATie;
 ...
 * <p>
 * Name="CSATCONTROL_1" Code="alma.CSATCONTROL_MODULE.CSATControlImpl.CSATControlHelper" Type="IDL:alma/CSATCONTROL_MODULE/CSATControl:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class CSATControlHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public CSATControlHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return CSATControlPOATie.class;
	}
	...
	*/
	...
	{
		return CSATControlOperations.class;
	}
