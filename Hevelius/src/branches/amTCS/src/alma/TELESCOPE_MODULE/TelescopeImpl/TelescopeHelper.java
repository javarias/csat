...
import alma.TELESCOPE_MODULE.TelescopePOATie;
 ...
 * <p>
 * Name="TELESCOPE_1" Code="alma.TELESCOPE_MODULE.TelescopeImpl.TelescopeHelper" Type="IDL:alma/TELESCOPE_MODULE/Telescope:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class TelescopeHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public TelescopeHelper(Logger containerLogger)
	{
