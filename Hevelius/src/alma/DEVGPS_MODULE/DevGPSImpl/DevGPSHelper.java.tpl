...
package alma.DEVGPS_MODULE.DevGPSImpl;
...
import alma.DEVGPS_MODULE.DevGPSOperations;
import alma.DEVGPS_MODULE.DevGPSPOATie;
import alma.DEVGPS_MODULE.DevGPSImpl.DevGPSImpl;
 ...
 * <p>
 * Name="DEVGPS_1" Code="alma.DEVGPS_MODULE.DevGPSImpl.DevGPSHelper" Type="IDL:alma/DEVGPS_MODULE/DevGPS:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class DevGPSHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public DevGPSHelper(Logger containerLogger)
	{
