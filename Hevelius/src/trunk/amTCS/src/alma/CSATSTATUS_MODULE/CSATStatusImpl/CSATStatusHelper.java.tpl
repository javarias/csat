...
import alma.CSATSTATUS_MODULE.CSATStatusPOATie;
 ...
 * <p>
 * Name="CSATSTATUS_1" Code="alma.CSATSTATUS_MODULE.CSATStatusImpl.CSATStatusHelper" Type="IDL:alma/CSATSTATUS_MODULE/CSATStatus:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class CSATStatusHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public CSATStatusHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return CSATStatusOperations.class;
	}
