...
//	private static Configuration test = new Configuration();
	...
	{		
		...
		TelescopeConverter.RA = RA;
		TelescopeConverter.DEC = DEC;
		...
		//RA = ALT;
		//DEC = AZ;
		TelescopeConverter.ALT = ALT;
		TelescopeConverter.AZ = AZ;

		//System.out.println(ALT+" "+AZ);
		//System.out.println(Converter.ALT+" "+Converter.AZ);
		//}
