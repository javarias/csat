#ifndef _EQUATORIALNEXSIMIMPL_H_
#define _EQUATORIALNEXSIMIMPL_H_
...
class EquatorialNexsimImpl : public virtual CharacteristicComponentImpl,
...
public:
	 ...
	 */
	EquatorialNexsimImpl(const ACE_CString& name, maci::ContainerServices* containerServices);
	/**
	 * Destructor
	 */
	virtual ~EquatorialNexsimImpl();
...
private:
	 ...
	 */
	void operator=(const EquatorialNexsimImpl&);
};
