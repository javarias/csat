#ifndef _PCDUMMYGPSIMPL_H_
#define _PCDUMMYGPSIMPL_H_
...
class PcDummyGpsImpl : public virtual CharacteristicComponentImpl,
                public virtual POA_DEVGPS_MODULE::DevGPS
{

public:

	PcDummyGpsImpl(const ACE_CString& name, maci::ContainerServices* containerServices);

	virtual ~PcDummyGpsImpl();
...
private:
	 ...
	 */
	void operator=(const PcDummyGpsImpl&);
};

#endif /* _PCDUMMYGPSIMPL_H_ */
