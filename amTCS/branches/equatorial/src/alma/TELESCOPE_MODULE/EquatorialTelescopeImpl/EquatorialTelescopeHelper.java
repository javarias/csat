...
import alma.TELESCOPE_MODULE.EquatorialTelescopePOATie;
import alma.TELESCOPE_MODULE.EquatorialTelescopeImpl.EquatorialTelescopeImpl;
 ...
 * <p>
 * Name="EQUATORIALTELESCOPE_1" Code="alma.TELESCOPE_MODULE.EquatorialTelescopeImpl.EquatorialTelescopeHelper" Type="IDL:alma/TELESCOPE_MODULE/EquatorialTelescope:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class EquatorialTelescopeHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public EquatorialTelescopeHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return new EquatorialTelescopeImpl();
	}
	...
	*/
	...
	{
		return EquatorialTelescopePOATie.class;
	}
	...
	*/
	...
	{
		return EquatorialTelescopeOperations.class;
	}
