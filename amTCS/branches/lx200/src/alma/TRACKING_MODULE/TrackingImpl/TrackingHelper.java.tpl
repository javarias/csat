...
import alma.TRACKING_MODULE.TrackingPOATie;
import alma.TRACKING_MODULE.TrackingImpl.TrackingImpl;
 ...
 * <p>
 * Name="TRACKING_1" Code="alma.TRACKING_MODULE.TrackingImpl.TrackingHelper" Type="IDL:alma/TRACKING_MODULE/Tracking:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class TrackingHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public TrackingHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return TrackingOperations.class;
	}
