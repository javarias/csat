...
import alma.CCD_MODULE.CCDPOATie;
import alma.CCD_MODULE.CCDImpl.CCDImpl;
 ...
 * <p>
 * Name="CCD_1" Code="alma.CCD_MODULE.CCDImpl.CCDHelper" Type="IDL:alma/CCD_MODULE/CCD:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class CCDHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public CCDHelper(Logger containerLogger)
	{
