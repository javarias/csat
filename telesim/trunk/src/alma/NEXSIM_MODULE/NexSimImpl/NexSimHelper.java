...
import alma.NEXSIM_MODULE.NexSimPOATie;
import alma.NEXSIM_MODULE.NexSimImpl.NexSimImpl;
 ...
 * <p>
 * Name="NEXSIM_1" Code="alma.NEXSIM_MODULE.NexSimImpl.NexSimHelper" Type="IDL:alma/NEXSIM_MODULE/NexSim:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class NexSimHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public NexSimHelper(Logger containerLogger)
	{
